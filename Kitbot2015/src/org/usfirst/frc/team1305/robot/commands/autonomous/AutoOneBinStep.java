...
public class AutoOneBinStep extends CommandGroup {
    ...
    public  AutoOneBinStep() {
    	...
    	addSequential(new AutonomousMobility(0.5, 0.5, 0.5)); //TODO: 3.5
    	addParallel(new AutonomousMobility(1.1, 0.5, 0.5)); //TODO: 3.5
    	addSequential(new AutonomousArmTransport(2.7));
